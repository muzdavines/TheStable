...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("playerStable", "otherStables", "gameDate", "freeAgentMarket", "contractMarket", "missionContractList", "modifierList", "mkt")]
	public class ES3UserType_Game : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WriteProperty("freeAgentMarket", instance.freeAgentMarket, ES3Internal.ES3TypeMgr.GetES3Type(typeof(FreeAgentMarket)));
			...
			writer.WriteProperty("mkt", instance.mkt, ES3Internal.ES3TypeMgr.GetES3Type(typeof(System.Collections.Generic.List<MissionContractTest>)));
		}
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "freeAgentMarket":
						instance.freeAgentMarket = reader.Read<FreeAgentMarket>();
						break;
					case "contractMarket":
					...
					case "modifierList":
						...
						break;
					case "mkt":
						instance.mkt = reader.Read<System.Collections.Generic.List<MissionContractTest>>();
						break;
					default:
						reader.Skip();
						break;
