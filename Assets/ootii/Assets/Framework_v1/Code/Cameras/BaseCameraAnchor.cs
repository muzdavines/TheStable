        ...
        protected virtual void AnchorLateUpdate(float rDeltaTime, int rUpdateIndex)
        {
            ...
            if (mIsTargetPostionSet)
            {
                ...
                if (mTargetRoot)
                {
                    ...
                    lTargetPosition += ((_RotationRoot != null ? _RotationRoot.up : _Root.up) * _RootOffset.y);
                    lTargetPosition += ((_RotationRoot != null ? _RotationRoot.forward : _Root.forward) * _RootOffset.z);
                }
            ...
            {
                Vector3 lNewAnchorPosition = _Root.position + ((_RotationRoot != null ? _RotationRoot.rotation : _Root.rotation) * _RootOffset);
                lNewAnchorPosition += ((_RotationRoot != null ? _RotationRoot.up : _Root.up) * _RootOffset.y);
                lNewAnchorPosition += ((_RotationRoot != null ? _RotationRoot.forward : _Root.forward) * _RootOffset.z);
