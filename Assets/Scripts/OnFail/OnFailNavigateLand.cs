...
public class OnFailNavigateLand : OnStepFail {
    ...
    public override void OnFail() {
        ...
        Helper.Speech(FindObjectOfType<MissionController>().currentActiveStepChar.transform, "Oh, no. This isn't the right way...");
    ...
    IEnumerator BroadcastNextStep() {
        ...
        FindObjectOfType<MissionController>().allChars[0].BroadcastNextStep();
    }
