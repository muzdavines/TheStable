...
public class MissionCharacterStateCamp : MissionCharacterState {
    ...
    public override void EnterFrom(MissionCharacterState state) {
        ...
        agent.SetDestination(walkTarget.position + new Vector3(3,0,0));
        didFireAction = false;
        quality = CampResult();
    ...
    public int CampResult() {
        ...
        int skill = thisChar.character.survivalist;
